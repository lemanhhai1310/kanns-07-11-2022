        ...
        <div class="uk-container">
            <div class="uk-grid-12 uk-grid" uk-grid>
                <div class="uk-width-1-1">
                    <div class="giacsodo__label">Trạng thái: <span>Thanh toán tiền mua NPL</span></div>
                </div>
                ...
                <div class="giacsodo__nhiemvu__box uk-padding-small uk-border-rounded item__11">
                    <div class="giacsodo__nhiemvu__item">
                        <div class="uk-flex-middle uk-grid-10 uk-grid" uk-grid>
                            <div class="uk-width-expand">
                                <div class="giacsodo__nhiemvu__box__label">Thanh toán tiền mua NPL</div>
                            </div>
                    ...
                    <div class="giacsodo__nhiemvu__item" id="my-show">
                        <div class="uk-grid-small uk-child-width-expand uk-grid">
                            <label class="ketoan__txt"><input class="uk-radio ketoan__radio" type="radio" name="radio2" checked> Chưa thanh toán</label>
                            <label class="ketoan__txt"><input class="uk-radio ketoan__radio" type="radio" name="radio2"> Đã thanh toán</label>
                        </div>
                        <div class="item__12">
                            <textarea class="uk-textarea ketoan__textarea" rows="2" placeholder="Ghi chú:" aria-label="Textarea"></textarea>
                        </div>
                    </div>
                </div>
...
<div class="giacsodo__boxBottom uk-section-xsmall uk-background-default uk-position-fixed uk-position-bottom">
    <div class="uk-container uk-container-expand">
        <div class="uk-grid uk-child-width-expand uk-grid-small">
            <div>
                <button class="giacsodo__boxBottom__btn uk-button uk-button-primary uk-border-rounded uk-button-large uk-width-1-1">Cập nhật</button>
            </div>
        </div>
    </div>
</div>
