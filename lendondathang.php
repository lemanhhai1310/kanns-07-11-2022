<?php $data["title"] = "Lên đơn đặt hàng"; ?>
<?php $bodyClass = ''; ?>
<?php $isMenu = false; ?>
<?php require "template-parts/layouts/header.php"; ?>
<!--Thêm thông số-->
<div id="offcanvas-overlay-themthongso" class="thumua__offcanvas" uk-offcanvas="overlay: true">
    <div class="uk-offcanvas-bar thumua__offcanvas__bar uk-flex uk-flex-column">
        ...
        <div class="thumua__offcanvas__header uk-position-relative uk-text-center">
            ...
            <h3 class="thumua__offcanvas__title uk-margin-remove">Thêm thông số</h3>
        </div>
        ...
        <div class="thumua__offcanvas__footer uk-section-xsmall">
            <div class="uk-container uk-container-expand">
                <button class="giacsodo__boxBottom__btn uk-button uk-button-primary uk-border-rounded uk-button-large uk-width-1-1" disabled>Thêm thông số</button>
            </div>
        </div>
    </div>
</div>
...
<div class="uk-background-default" uk-height-viewport="offset-bottom: true">
    ...
    <div class="uk-section-xsmall uk-background-box">
        <div class="uk-container">
            <div class="uk-grid-12 uk-grid" uk-grid>
                <div class="uk-width-1-1">
                    <div class="giacsodo__label">Trạng thái: <span>Lên đơn đặt hàng</span></div>
                </div>
                        ...
                        <div class="giacsodo__nhiemvu__box uk-padding-small uk-border-rounded">
                            <div class="giacsodo__nhiemvu__item">
                                <div class="uk-flex-middle uk-grid-10 uk-grid" uk-grid>
                                    <div class="uk-width-expand">
                                        <div class="giacsodo__nhiemvu__box__label">Lên đơn đặt hàng</div>
                                    </div>
                                    <div class="uk-width-auto">
                            ...
                            <div class="giacsodo__nhiemvu__item" id="my-show">
                                <div class="uk-grid item__8 uk-flex-middle" uk-grid="">
                                    <div class="uk-width-expand">
                                        <div class="giacsodo__nhiemvu__box__label"><strong>Ngày bắt đầu đặt hàng</strong></div>
                                    </div>
                                    <div class="uk-width-auto">
                                ...
                                <div class="uk-grid item__8 uk-flex-middle" uk-grid="">
                                    <div class="uk-width-expand">
                                        <div class="giacsodo__nhiemvu__box__label"><strong>Số lượng mã hàng</strong></div>
                                    </div>
                                </div>
                                <div class="item__8" style="padding-left: 20px">
                                    <div class="uk-grid item__8 uk-flex-middle uk-grid-10" uk-grid="">
                                        <div class="uk-width-expand">
                                        ...
                                        <div class="uk-width-auto">
                                            <a href="" uk-icon="icon: trash" uk-tooltip="Remove"></a>
                                        </div>
                                    </div>
                                    <div class="uk-grid item__8 uk-flex-middle uk-grid-10" uk-grid="">
                                        <div class="uk-width-expand">
                                    ...
                                    <div class="item__8 uk-text-right">
                                        <button class="lendondathang__btnAdd uk-border-rounded uk-button uk-button-default uk-button-small" uk-icon="icon: plus; ratio: .7" uk-toggle="target: #offcanvas-overlay-themthongso">Thêm thông số</button>
                                    </div>
                                    <div class="uk-grid item__8 uk-flex-middle uk-grid-10" uk-grid="">
                                        <div class="uk-width-expand">
                                ...
                                <div class="uk-grid item__8 uk-flex-middle" uk-grid="">
                                    <div class="uk-width-expand">
                                        <div class="giacsodo__nhiemvu__box__label"><strong>Giá vốn</strong></div>
                                    </div>
                                    <div class="uk-width-auto">
                                        <div class="uk-position-relative">
                                            <input class="uk-input giacsodo__input uk-form-small uk-form-width-small" style="width: 160px" type="text" placeholder="" aria-label="Input">
                                ...
                                <div class="uk-grid item__8 uk-flex-middle" uk-grid="">
                                    <div class="uk-width-expand">
                                        <div class="giacsodo__nhiemvu__box__label"><strong>Đặt cọc 50%</strong></div>
                                    </div>
                                    <div class="uk-width-auto">
                                        <div class="uk-position-relative">
                                            <input class="uk-input giacsodo__input uk-form-small uk-form-width-small" style="width: 160px" type="text" placeholder="" aria-label="Input" disabled>
                                            <span class="uk-position-center-right uk-position-small">đ</span>
                                        </div>
                                    </div>
                                </div>
