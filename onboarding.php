    ...
    <div class="onboarding uk-height-viewport" uk-height-viewport="offset-bottom: true">
        <div class="uk-section-xsmall">
            <div class="uk-container">
                ...
                <div class="item__15 onboarding__box1 onboarding__box1--doing">
                    <div class="uk-flex-middle uk-grid-small" uk-grid>
                        ...
                        <div class="uk-width-expand">
                            <h4 class="uk-h4 onboarding__box1__title">Mẫu đang làm</h4>
                        </div>
                    </div>
                </div>

                <div class="item__15 onboarding__box1 onboarding__box1--finish">
                    <div class="uk-flex-middle uk-grid-small" uk-grid>
                        <div class="uk-width-auto">
                ...
                <div class="item__15 onboarding__box2">
                            ...
                            foreach ($data as $k => $v): ?>
                                <div>
                                    <div class="uk-flex uk-flex-column uk-flex-middle <?= $v['class'] ?>">
                                        <span class="uk-icon-button onboarding__box2__icon"
                                              uk-icon="<?= $v['icon'] ?>"></span>
                    ...
                    <div class="onboarding__box2__item">
                        ...
                        <div class="uk-text-center item__16"><a class="onboarding__box2__linkTxt" href="">Xem tất cả
                                (10)</a></div>
                    </div>
                </div>
            </div>
