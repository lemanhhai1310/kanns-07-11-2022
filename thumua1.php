<?php $data["title"] = "Thu mua 1"; ?>
<?php $bodyClass = ''; ?>
<?php $isMenu = false; ?>
<?php require "template-parts/layouts/header.php"; ?>
<div id="offcanvas-overlay-xacnhanmuahang" class="thumua__offcanvas" uk-offcanvas="overlay: true">
    <div class="uk-offcanvas-bar thumua__offcanvas__bar uk-flex uk-flex-column">
        ...
        <div class="thumua__offcanvas__header uk-position-relative uk-text-center">
            ...
            <h3 class="thumua__offcanvas__title uk-margin-remove">Xác nhận mua hàng</h3>
        </div>
        ...
        <div class="thumua__offcanvas__footer uk-section-xsmall">
            <div class="uk-container uk-container-expand">
                <button class="giacsodo__boxBottom__btn uk-button uk-button-primary uk-border-rounded uk-button-large uk-width-1-1" disabled>Xác nhận</button>
            </div>
        </div>
    </div>
</div>
<div class="uk-background-default" uk-height-viewport="offset-bottom: true">
    ...
    <div class="uk-section-xsmall uk-background-box">
        <div class="uk-container">
            <div class="uk-grid-12 uk-grid" uk-grid>
                <div class="uk-width-1-1">
                    <div class="giacsodo__label">Trạng thái: <span>Đang mua hàng mẫu</span></div>
                </div>
                <div class="uk-width-1-2">
                    <div class="uk-width-1-1 uk-form-custom" uk-form-custom="target: > * > span:first-child">
                        <select aria-label="Custom controls">
                ...
                <div class="giacsodo__nhiemvu__box uk-padding-small uk-border-rounded item__11">
                    <div class="giacsodo__nhiemvu__item">
                        <div class="uk-flex-middle uk-grid-10 uk-grid" uk-grid>
                            <div class="uk-width-expand">
                                <div class="giacsodo__nhiemvu__box__label">Mua nguyên phụ liệu mẫu</div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="thumua__chonmua__item">
                                ...
                                <div class="item__8">
                                    <div class="uk-grid-10 uk-flex-middle" uk-grid>
                                        ...
                                        <div class="uk-width-auto">
                                            <a href="#offcanvas-overlay-xacnhanmuahang" uk-toggle class="thumua__chonmua__icon thumua__chonmua__icon--archive" uk-icon="icon: file-edit"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="giacsodo__boxBottom uk-section-xsmall uk-background-default uk-position-fixed uk-position-bottom">
    <div class="uk-container uk-container-expand">
        <button class="giacsodo__boxBottom__btn uk-button uk-button-primary uk-border-rounded uk-button-large uk-width-1-1">Hoàn thành</button>
    </div>
</div>
