        ...
        <div class="uk-container">
            <div class="uk-grid-12 uk-grid" uk-grid>
                <div class="uk-width-1-1">
                    <div class="giacsodo__label">Trạng thái: <span>Đầu chuyền</span></div>
                </div>
                        ...
                        <div class="giacsodo__nhiemvu__box uk-padding-small uk-border-rounded">
                            <div class="giacsodo__nhiemvu__item">
                                <div class="uk-flex-middle uk-grid-10 uk-grid" uk-grid>
                                    <div class="uk-width-expand">
                                        <div class="giacsodo__nhiemvu__box__label">May sản phẩm mẫu lần 1</div>
                                    </div>
                                    <div class="uk-width-auto">
                            ...
                            <div class="giacsodo__nhiemvu__item" id="my-show">
                                <div class="uk-grid item__8 uk-flex-middle" uk-grid="">
                                    <div class="uk-width-expand">
                                        <div class="giacsodo__nhiemvu__box__label">Ngày có mẫu đầu chuyền</div>
                                    </div>
                                    <div class="uk-width-auto">
                                        <input style="width: 130px" type="date" class="thumua__thoigian__input uk-input uk-width-small uk-form-small uk-border-rounded">
                                    </div>
                                </div>
                            </div>
                        </div>
